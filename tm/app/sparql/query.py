...
def get_patient_select_clause(form_data: PatientDataForm):
    variables = get_patient_variable_list(form_data)
    select_clause = "SELECT " + ', '.join(variables)
...
def get_patient_selection_dict(form_data: PatientDataForm):
    ...
    patient_selection_dict["healthcare_coverage"] = form_data.healthcare_coverage.data
    patient_selection_dict["healthcare_expenses"] = form_data.healthcare_expenses.data
